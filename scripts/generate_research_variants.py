...
risk_variants = [
    {
        ...
        "dal_required": False,
        "models": {"generator": "LED/T5-small summarizer", "reranker": "LegalBERT", "option": "Mistral 7B QLoRA (optional, single GPU)"},
        "kg": {"ontology": "EAR v1", "reasoning": ["none", "RDFS"], "storage": "Jena TDB2"},
        "retrieval": {"type": "BM25 + optional FAISS", "filters": ["entity type", "date"], "fusion": "RRF"},
        ...
        "acceptance": ["Deterministic corpora", "Latency P95 < 1500ms", "Attribution ≥ baseline"],
        "gpt5_prompts": [
    ...
    },
    {
        ...
        "dal_required": False,
        "models": {"generator": "Mistral 7B QLoRA", "embeddings": "E5-legal-base", "reranker": "LegalBERT"},
        "kg": {"ontology": "EAR v1", "reasoning": ["RDFS", "OWL Mini"], "storage": "Jena TDB2"},
        "retrieval": {"type": "Hybrid BM25 + dense", "fusion": "RRF", "cache": "feature+snippet"},
        ...
        "acceptance": ["QA EM improves ≥ X%", "Retrieval nDCG@10 ≥ baseline", "P95 < 2000ms"],
        "gpt5_prompts": [
    ...
    },
    {
        ...
        "dal_required": True,
        "models": {"generator": "Llama 3.1 70B QLoRA/LoRA", "embeddings": "E5-large-legal"},
        "kg": {"ontology": "EAR v1", "reasoning": ["OWL Mini"], "storage": "TDB2 inference service"},
        "retrieval": {"type": "Hybrid + learned reranking", "fusion": "weighted", "cache": "embedding+snippet"},
        ...
        "acceptance": ["Significant QA gains vs moderate tier", "Stable latency under load", "Reproducible runs on DAL"],
        "gpt5_prompts": [
...
iswc = {
    ...
    "methods": {
        "kg": {"ontology": "EAR v1", "reasoning": ["RDFS", "OWL Mini"], "validation": "SHACL"},
        "grounding": ["template-based SPARQL", "path extraction"],
        "explainability": ["lineage graphs", "attribution"],
        "evaluation": {"kg_quality": ["SHACL conforms", "isomorphism"], "qa": ["accuracy", "attribution"], "perf": ["SPARQL latency"]}
    },
...
kdd = {
    ...
    "methods": {
        ...
        "generation": {"model": "Mistral/Llama QLoRA", "guardrails": ["policy-aware decoding"]},
